...
#### Block: Primary Navigation [id="primary-nav" type="nav" variant="primary" gap="sm"]
- nav-item#nav-dashboard: Dashboard [action="navigate:executive-dashboard"]
...
#### Block: Page Header [id="exec-page-header" type="page-header" variant="with-actions" gap="sm"]
- text#exec-title: Revenue workspace
...
#### Block: Forecast Metrics [id="forecast-metrics" type="metric-row" gap="md" content="forecast-metrics-data"]

#### Block: Pipeline Filters [id="pipeline-filters" type="filters" variant="inline" gap="sm"]
...
- text#risk-review-copy: Risk view highlights legal, security, and procurement blockers.
- button#risk-review-dismiss: Clear risk review [action="toggle:risk-review-panel"]

#### Block: Opportunity Table [id="opportunity-table" type="data-table" variant="selectable" gap="md" content="opportunity-rows"]
- column#opp-col-account: Account
- column#opp-col-stage: Stage
- column#opp-col-owner: Owner
- column#opp-col-amount: Amount

#### Block: Account Detail [id="account-detail-panel" type="detail-panel" variant="summary" gap="md" content="account-summary"]
...
#### Block: Activity Feed [id="exec-activity" type="activity-feed" variant="compact" gap="sm" content="activity-items"]
...
#### Block: Detail Navigation [id="pipeline-nav" type="nav" variant="compact" gap="sm"]
...
#### Block: Review Header [id="pipeline-header" type="page-header" gap="sm"]
...
#### Block: Settings Navigation [id="settings-nav" type="nav" variant="compact" gap="sm"]
